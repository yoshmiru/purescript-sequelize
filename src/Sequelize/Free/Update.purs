...
data UpdateF a next
  ...
  | Increment (Instance a) (Map String Int) next
  | Decrement (Instance a) (Map String Int) next
  | UpdateModel
    (Options a)
    (Options a)
...
incrementF :: forall a. Instance a -> Map String Int -> UpdateF a Unit
incrementF i strmap = Increment i strmap unit

decrementF :: forall a. Instance a -> Map String Int -> UpdateF a Unit
