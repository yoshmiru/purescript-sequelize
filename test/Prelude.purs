...
import Effect.Aff (Aff, launchAff) as Exports
import Effect.Class.Console (log, logShow) as Exports
import Effect (Effect) as Exports
--import Effect.Class.Console (CONSOLE) as Exports
--import Effect.Exception (EXCEPTION) as Exports
...
foreign import data CONSOLE :: Exports.Effect
foreign import data EXCEPTION :: Exports.Effect

type TestAff e = e
type TestEff e = TestAff e
type AffTest e a = Exports.Aff a
type EffTest e a = Exports.Effect a
